# Портфель інженерних ініціатив: як обирати, фінансувати й зупиняти роботу

Найскладніше портфельне рішення — не почати нову ініціативу, а вчасно зупинити або відкласти ту, що вже має прихильників і витрати. У середовищі зі спільними інженерними ресурсами кожне таке рішення змінює можливість виконати інші зобов’язання. Ця стаття дає повний практичний розбір портфельного управління.

## Портфель як вибір між обмеженими можливостями
...
## Відмінність портфельного та програмного управління
...
## Оцінювання цінності, ризику й відповідності
...
## Ризики портфельного управління
...
Портфельне управління не зводиться до ранжування ідей. Це повторюваний спосіб порівнювати цінність, ризик, обмеження й наслідки для спільної спроможності. Якісний портфель показує не лише те, що організація робить, а й що вона свідомо не робить — і чому.
