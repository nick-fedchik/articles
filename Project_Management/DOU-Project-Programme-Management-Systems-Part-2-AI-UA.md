...
У першій частині йшлося про біль сьогоднішніх систем проєктного і програмного управління: багато інструментів, ручна синхронізація, апаратно-програмні залежності, великий WBS, віхи, комітет з керування змінами (CCB), докази відповідності і розрив між планом та реальною інженерною роботою. Тепер питання практичніше: якою має бути інтегрована система, у якій AI-асистент, локальні LLM та експертні системи справді допомагають роботі, а не прикрашають план розвитку красивою AI-обіцянкою.
...
## AI-асистент має працювати в контексті
...
## LLM потребує керованого контексту
...
У середовищі з жорсткими вимогами відповідності фраза "AI так сказав" не є доказом. Потрібні джерела, версії, шлях міркування і відповідальний власник. AI-вивід може бути кандидатом у доказ, але не заміною результату тесту, погодження, запису огляду або підписаного рішення.
...
Архітектура AI для конфіденційної інженерії має починатися з управління даними і моделі загроз, а не з демо.
