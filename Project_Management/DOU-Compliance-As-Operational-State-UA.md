...
## Чому audit readiness часто з'являється лише перед аудитом
...
## Чому PM/PgM потребує daily compliance view
...
## AI у compliance: пояснення, gaps, draft-reports
...
## Audit package як постійний артефакт
...
## Як виглядає daily compliance loop
