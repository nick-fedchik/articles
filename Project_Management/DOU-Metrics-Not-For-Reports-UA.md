# Метрики не для звіту: як project metrics мають працювати в реальному часі
...
## Метрика має мати owner-а і threshold
...
## Роль AI: не просто пояснити графік
...
## Метрики мають запускати workflow
