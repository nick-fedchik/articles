...
> **Серія:** [Експертні системи для R&D](README.md) · стаття 08 із 22  
...
У ній $n$ — кількість перевірених випадків, $\mathrm{conf}$ — середня заявлена впевненість, а $\mathrm{acc}$ — фактична точність у кошику. Чим ближче ECE до нуля, тим чесніше число впевненості описує реальність; однак малий ECE не доводить коректність усієї системи — потрібні ще якість доказів, coverage і контроль відмов.
