...
### Де її місце серед інших програм
...
Якщо ви вперше читаєте про експертні системи, на цьому етапі достатньо чотирьох
ідей:
...
Одна й та сама технічна основа може працювати в різних галузях, але однакові
правила не можна без перевірки переносити між автомобілями, авіацією,
медициною, оборонними технологіями та законодавством. У кожній галузі різні
ризики, докази, межі автоматизації й особи, уповноважені приймати рішення.

| Домен | Практична проблема для експертної системи | Типові знання й докази | Межа автоматизації та остаточні повноваження |
|---|---|---|---|
| Автомобільна інженерія (*Automotive*) | простежити шлях від вимоги через код до тесту; оцінити вплив зміни; допомогти з діагностикою | вимоги, архітектурні рішення, аналізи ризиків і відмов, звіти тестів та польові інциденти | система знаходить прогалини й готує пакет обґрунтування; відповідальна за безпеку або кібербезпеку особа приймає формальне рішення |
| Авіація (*Aviation*) | контролювати конфігурацію, допомагати з технічним обслуговуванням і аналізом подій | вимоги до літака й систем, затверджені конфігурації, матеріали перевірки, керівництва з обслуговування та звіти про події | система починає з дорадчих завдань із нижчим ризиком; застосування на борту або у функціях безпеки потребує окремого обґрунтування й схвалення |
| Медицина (*Medicine*) | підтримати клінічне рішення, перевірити протипоказання та знайти відповідну настанову | дані конкретного пацієнта, клінічні настанови, дослідження перевірки та відомі обмеження моделі | система показує підстави рекомендації; медичний працівник і застосовні регуляторні правила визначають дію |
| Військові й оборонні технології (*Military/Defence*) | підтримати ситуаційну обізнаність, логістику, технічну діагностику та обслуговування | дані сенсорів і повідомлень із відомим походженням, технічні керівництва, дані готовності, політики й захищені джерела | система не привласнює командні повноваження; людина зберігає контроль, а безпека й правомірність задають межі |
| Законодавство (*Legislation*) | знайти чинну норму, порівняти редакції, виявити можливу колізію та оцінити вплив законопроєкту | офіційні тексти, дати чинності, юрисдикція, зв'язки між нормами, судові рішення та матеріали підготовки акта | система пропонує аналіз із точними цитатами й часовими межами; владне або професійне юридичне рішення залишається за уповноваженою особою |
