...
> **Серія:** [Експертні системи для R&D](README.md) · стаття 27 із 28  
...
> **Наступна стаття:** [28 — Дворежимні експертні системи: поєднання строгої сертифікаційної верифікації та евристичного дорадчого виведення](28-dual-mode-expert-systems-deduction-induction-cbr-UA.md)  
