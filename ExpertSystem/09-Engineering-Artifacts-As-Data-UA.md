...
> **Серія:** [Експертні системи для R&D](README.md) · стаття 09 із 21  
...
$$
\operatorname{Coverage}_{R\rightarrow T}=
...
Тут $f(t,d)$ — частота терма, $|d|/\operatorname{avgdl}$ коригує довжину документа, $k_1$ задає насичення частоти, а $b$ — силу нормалізації довжини. Формула пояснює, чому рідкісний точний код вимоги може бути ціннішим за часте загальне слово.
